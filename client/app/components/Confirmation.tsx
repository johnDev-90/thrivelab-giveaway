      ...
      <div className="max-w-md mx-auto space-y-4">
        ...
        <div className="border-t border-gray-200 pt-4 mt-6">
          <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
            Thank you for sharing more about your health goals. Whether you're
            the lucky winner or not, this is the first step toward exploring
            what's possible with regenerative medicine.
          </p>
        </div>
